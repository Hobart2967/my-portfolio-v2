	...
	return <div class="card legal-dialog">
			...
			<div>
				...
				<div>
					...
					<div>
						Email: <a
							target="_blank"
							href="mailto:marcoklein.engineer@outlook.com">
							marcoklein.engineer&#64;outlook.com
						</a>
					</div>
				</div>
			</div>
			<div>
				<div>
					...
					<p>
						...
						<a target="_blank" href="mailto:marcoklein.engineer@outlook.com">
							marcoklein.engineer&#64;outlook.com
						</a>.
					</p>
					...
					<p>
						All the information on this website - https://www.marcoklein.engineer - is
						published in good faith and for general information purpose only. Marco Klein
						does not make any warranties about the completeness, reliability and accuracy of this information.
						Any action you take upon the information you find on this website (Marco Klein),
						is strictly at your own risk. Marco Klein will not be liable for any losses
						and/or damages in connection with the use of our website.
					</p>

					<p>
						From our website, you can visit other websites by
						following hyperlinks to such external sites.
						...
						for all the content found on these sites. Site owners and content may change
						without notice and may occur before we have the opportunity to remove a
		...
		<div>
			...
			<div>
				...
				valid for visitors to our website with regards to
				the information that they shared and/or collect in Marco Klein.
			...
			<div>
				...
				send us, and any other information you may choose to
				provide.
			</div>
			<div>
			...
			<ul>
				...
				<li>Communicate with you, either directly or through one of our partners,
					including for customer service, to provide
			...
			<div>
				Marco Klein follows a standard procedure of using log files.
				...
				date and time stamp, referring/exit
			...
			<div>
				...
				the advertising partners of Marco Klein.
			</div>

			<div>
				Third-party ad servers or ad networks uses technologies like cookies,
				JavaScript, or Web Beacons that are used in their respective advertisements
				and links that appear on Marco Klein, which are sent directly to users' browser.
			...
			<div>
				Note that Marco Klein has no access to or control over these cookies
				that are used by third-party advertisers.
			</div>

			<h2>Third Party Privacy Policies</h2>

			<div>Marco Klein's Privacy Policy does not apply to other
			...
			<div>
				...
				options. To know more detailed information about
			...
			<h2>Hosting</h2>
			<div>
				This website is hosted on GitHub as Github Pages.
				Please refer to the <a href="https://docs.github.com/en/github/site-policy/global-privacy-practices">
					Github Global Privacy Practices</a> for more detailed information.
			</div>
			...
			<div>
				...
				using the internet. We encourage parents and
				guardians to observe, participate in, and/or monitor and guide their online activity.</div>

			<div>
				Marco Klein does not knowingly collect any Personal Identifiable Information
				from children under the age of 13. If
