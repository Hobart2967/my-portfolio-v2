...
export function LegalDialog(props: LegalDialogProps) {
	return (
		<div class="card legal-dialog">
			<div class="dp-f g-8 header">
				<div>
					<div>
						<h1>
							Legal notice for www.marcoklein.engineer
						</h1>
				...
				<div>
					<div>
						<h1>
							Disclaimer for www.marcoklein.engineer
						</h1>
						...
						<p>
							...
							you find on this website (Marco Klein),
			...
			<div>
				<h1>
					Privacy Policy for www.marcoklein.engineer
				</h1>
				...
				<div>
					Marco Klein's Privacy Policy does not apply to other
				...
				<div>
					...
					<a href="https://docs.github.com/en/github/site-policy/global-privacy-practices">
